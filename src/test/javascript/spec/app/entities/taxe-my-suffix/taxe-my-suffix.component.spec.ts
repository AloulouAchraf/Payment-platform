...
import { TaxeMySuffixComponent } from 'app/entities/taxe-my-suffix/taxe-my-suffix.component';
...
describe('Component Tests', () => {
    describe('TaxeMySuffix Management Component', () => {
        let comp: TaxeMySuffixComponent;
        let fixture: ComponentFixture<TaxeMySuffixComponent>;
        let service: TaxeMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [BlockchainAppTestModule],
                declarations: [TaxeMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TaxeMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(TaxeMySuffixComponent);
