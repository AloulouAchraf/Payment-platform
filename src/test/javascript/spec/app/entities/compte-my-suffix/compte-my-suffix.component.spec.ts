...
import { CompteMySuffixComponent } from 'app/entities/compte-my-suffix/compte-my-suffix.component';
...
describe('Component Tests', () => {
    describe('CompteMySuffix Management Component', () => {
        let comp: CompteMySuffixComponent;
        let fixture: ComponentFixture<CompteMySuffixComponent>;
        let service: CompteMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [BlockchainAppTestModule],
                declarations: [CompteMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CompteMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CompteMySuffixComponent);
